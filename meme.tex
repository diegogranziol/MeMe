...
\begin{figure}[htp]
	...
	\subfloat[$201,600$ nodes and $305$ clusters]{\label{figur:5}\includegraphics[width=40mm]{Figures/SynNet_n=201600_c=305.eps}}
	\subfloat[$404,420$ nodes and $1,355$ clusters]{\label{figur:6}\includegraphics[width=40mm]{Figures/SynNet_c_1355_n_404420.eps}}
	\\
	\subfloat[Email Dataset]{\label{figur:7}\includegraphics[width=40mm]{Figures/Error_for_EmailL.eps}}
	\subfloat[Netscience Dataset]{\label{figur:8}\includegraphics[width=40mm]{Figures/Error_for_NetscienceL.eps}}
